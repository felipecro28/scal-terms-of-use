...
const SageAISection = () => {
  return (
    <section className="py-20 px-6 relative overflow-hidden" id="sage">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(19,145,110,0.2)_0%,_transparent_70%)] pointer-events-none"></div>
      ...
      <div className="container mx-auto relative">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-scal-white">
            Conheça a <span className="text-scal-lime-green">Sage</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            <div className="aspect-video bg-scal-dark-green/80 rounded-xl overflow-hidden shadow-lg shadow-scal-lime-green/10">
              <iframe 
                width="100%" 
                height="100%" 
          ...
          <div className="space-y-6 order-1 lg:order-2">
            <h3 className="text-2xl font-museo font-bold text-scal-lime-green">
            ...
            <a href="#demo" className="button-primary inline-flex mt-4">
